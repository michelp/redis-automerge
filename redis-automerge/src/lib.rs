...
redis_module! {
    ...
    init: init,
    commands: [
        ["am.new", am_new, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.load", am_load, "write", 1, 1, 1, AclCategory::Write],
        ["am.save", am_save, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.apply", am_apply, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.changes", am_changes, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.numchanges", am_numchanges, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.getdiff", am_getdiff, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.tojson", am_tojson, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.fromjson", am_fromjson, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.puttext", am_puttext, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.gettext", am_gettext, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.putdiff", am_putdiff, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.splicetext", am_splicetext, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.markcreate", am_markcreate, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.markclear", am_markclear, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.marks", am_marks, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.putint", am_putint, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.getint", am_getint, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.putdouble", am_putdouble, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.getdouble", am_getdouble, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.putbool", am_putbool, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.getbool", am_getbool, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.putcounter", am_putcounter, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.getcounter", am_getcounter, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.inccounter", am_inccounter, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.puttimestamp", am_puttimestamp, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.gettimestamp", am_gettimestamp, "readonly", 1, 1, 1, AclCategory::Read],
        ["am.createlist", am_createlist, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.appendtext", am_appendtext, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.appendint", am_appendint, "write deny-oom", 1, 1, 1, AclCategory::Write],
        ["am.appenddouble", am_appenddouble, "write deny-oom", 1, 1, 1, AclCategory::Write],
